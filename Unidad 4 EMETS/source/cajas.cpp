...
///Reiniciar el juego
void JugadorReiniciar() {Jugador->SetTransform(b2Vec2(50.0f, 450.0f), 0.0f); Jugador->SetLinearVelocity(b2Vec2(0.0f, 0.0f)); estado = EstadoJuego::Running;	instruccionesb = true;}
...
void CrearMeta(){meta = CrearFigura(950.0f,515.0f,25.0f,25.0f,0.0f,0.0f,0.0f,b2_staticBody);meta->GetFixtureList()->SetSensor(true);
