...
////Obstaculo
void ObstaculoCrear(){obstaculo = CrearFigura(480.0f, 350.0f, 25.0f, 30.0f, 0.1f, 0.5f, 0.0f, b2_dynamicBody);}


void JugadorReiniciar() {
	Jugador->SetTransform(b2Vec2(50.0f, 450.0f), 0.0f); Jugador->SetLinearVelocity(b2Vec2(0.0f, 0.0f));
	obstaculo->SetTransform(b2Vec2(480.0f, 350.0f), 0.0f); obstaculo->SetLinearVelocity(b2Vec2(0.0f, 0.0f));
}
